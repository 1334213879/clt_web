<?php /*a:3:{s:75:"D:\phpStudy\PHPTutorial\WWW\clt_web\application\home\view\article_show.html";i:1573610849;s:74:"D:\phpStudy\PHPTutorial\WWW\clt_web\application\home\view\common_head.html";i:1573623714;s:76:"D:\phpStudy\PHPTutorial\WWW\clt_web\application\home\view\common_footer.html";i:1573610849;}*/ ?>
<html lang="zh_cn">
<head>
    <meta charset="utf-8">
    ...
    <nav>
        <div class="center">
            <ul class="clearfix aaa">
                ...
                <li class="er_li"><a href="./index.php">网站首页</a></li>
                <li><a href="./zcgs.php" target="_blank">公司注册</a></li>
                <li><a href="./dljz.php" target="_blank">代理记账</a></li>
                <li><a href="./zzdb.php" target="_blank">资质代办</a></li>
                <li><a href="./zscq.php" target="_blank">知识产权</a></li>
                <li><a href="./gsbg.php" target="_blank">公司变更</a></li>
                <li><a href="./zxgs.php" target="_blank">公司注销</a></li>
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md8 content detail">
            <div class="fly-panel detail-box">
                <h1 style="<?php echo htmlentities($info['title_style']); ?>"><?php echo htmlentities($info['title']); ?></h1>
                <div id="breadcrumb">
                ...
                <div class="fly-detail-info">
                    ...
                    <?php elseif(($info['posid'] == 1 or $info['posid'] == 2)): ?>
                    <span class="layui-badge fly-badge-accept">推荐</span>
                    <?php endif; ?>
                    <span><?php echo htmlentities($info['time']); ?></span>
                    <span class="fly-list-nums"><i class="iconfont" title="点击">&#xe60b;</i> <?php echo htmlentities($info['hits']); ?></span>
                </div>
        ...
        <div class="layui-col-md4">
            ...
            ->where("posid = 1 or posid=2 and (status = 1 or (status = 0 and createtime <1573627427))")
