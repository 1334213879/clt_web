<?php /*a:3:{s:72:"D:\phpStudy\PHPTutorial\WWW\clt_web\application\user\view\set\index.html";i:1573610849;s:79:"D:\phpStudy\PHPTutorial\WWW\clt_web\application\user\view\common\loginHead.html";i:1573610849;s:76:"D:\phpStudy\PHPTutorial\WWW\clt_web\application\user\view\common\footer.html";i:1573610849;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="main">
        ...
        <div class="nav-user">
            <a class="avatar" href="<?php echo url('index/index'); ?>">
                ...
                <img src="<?php echo imgUrl($userInfo['avatar']); ?>" alt="<?php echo htmlentities($userInfo['username']); ?>">
                <?php else: ?>
                <img src="/static/user/images/avatar/default.png" alt="<?php echo htmlentities($userInfo['username']); ?>">
                <?php endif; ?>
                <cite><?php echo htmlentities($userInfo['username']); ?></cite>
                <i><?php echo htmlentities($userInfo['level_name']); ?></i>
            </a>
            <div class="nav">
                    ...
                    <form method="post">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_email" name="email" lay-verify="email" value="<?php echo htmlentities($userInfo['email']); ?>" class="layui-input">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_mobile" name="mobile" lay-verify="mobile" value="<?php echo htmlentities($userInfo['mobile']); ?>" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label for="L_username" class="layui-form-label">昵称</label>
                            <div class="layui-input-inline">
                                <input type="text" id="L_username" name="username" lay-verify="required" value="<?php echo htmlentities($userInfo['username']); ?>" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <select name="province" lay-filter="province">
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($userInfo['province'] == $vo['id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                            ...
                            <div class="layui-input-inline">
                                <select name="city" lay-filter="city" id="city">
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($userInfo['city'] == $vo['id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <div class="layui-input-inline">
                                <select name="district" id="district">
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($userInfo['district'] == $vo['id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="随便写些什么刷下存在感" id="sign"  name="sign" class="layui-textarea" style="height: 80px;"><?php echo htmlentities($userInfo['sign']); ?></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <div class="layui-form-item">
                        <div class="avatar-add">
                            ...
                            <img src="<?php echo imgUrl($userInfo['avatar']); ?>" alt="<?php echo htmlentities($userInfo['username']); ?>">
                            <?php else: ?>
                            <img src="__STATIC__/user/images/avatar/default.png" alt="<?php echo htmlentities($userInfo['username']); ?>">
                            <?php endif; ?>
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <ul class="app-bind">
                        <li class="fly-msg app-havebind">
                            ...
                            <?php if((session('user.qq') == 1)): ?>
                            <span>已成功绑定，您可以使用QQ帐号直接登录Fly社区，当然，您也可以</span>
                            <a href="javascript:;" class="acc-unbind" type="qq_id">解除绑定</a>
                            <?php else: ?>
                            <a href="<?php echo url('oauth/qq'); ?>" onclick="layer.msg('正在绑定QQ', {icon:16, shade: 0.1, time:0})" class="acc-bind" type="qq_id">立即绑定</a>
